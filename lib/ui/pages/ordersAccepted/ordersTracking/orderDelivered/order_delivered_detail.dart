...
class OrderDeliveredDetail extends StatefulWidget {
    ...
    OrderDeliveredDetail(this.id,this.address,this.phone,this.date,this.namepickup,this.notes_order);

    @override

    _OrderDeliveredDetail createState() => _OrderDeliveredDetail();

}

class _OrderDeliveredDetail extends State<OrderDeliveredDetail>{

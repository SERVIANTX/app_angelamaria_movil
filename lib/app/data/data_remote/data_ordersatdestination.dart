...
class Data_OrdersAtDestination{
  ...
  Data_OrdersAtDestination(this.id_order,this.id_customer,this.address_order,this.phone_order,this.date_order,this.notes_order,this.displayname_customer);

  Data_OrdersAtDestination.fromJson(Map<String, dynamic> json){
